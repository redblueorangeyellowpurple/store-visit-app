  ...
  return (
    <main className="min-h-screen pb-28">
      ...
      <div className="space-y-2 px-3.5 mt-4">
        ...
        {/* People & engagements — list + open the shared editor sheet */}
        {(() => {
          const engagedPeople = visit.engaged_people ?? [];
          if (engagedPeople.length === 0 && !canEditTraining) return null;
          return (
            <div className="rounded-[18px] border border-ink-100 bg-white p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
      ...
      {/* Engagement editor — same sheet the view page opens */}
      {initDataStr && (
        <EngagementEditor
